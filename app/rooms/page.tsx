...
export const metadata: Metadata = {
  title: "Rooms & Suites | Cumberland Motor Inn",
  description:
    "Explore our coastal rooms and suites at Cumberland Motor Inn. Designed for comfort, relaxation, and stunning lake or garden views.",
};
                    ...
                    <div>
                      ...
                      <div className="p-6 flex flex-col">
                        ...
                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-[#50544E] font-manrope mb-4 pb-3.5 border-b border-[#D9D0C4]/40 min-h-[2.25rem]">
                          <span className="font-medium">{room.guestsLabel}</span>
                          <span className="text-[#D9D0C4]">•</span>
                          <span className="font-medium">{room.bedConfiguration}</span>
                          {room.areaLabel && (
                            <>
                              <span className="text-[#D9D0C4]">•</span>
                              <span className="font-medium">{room.areaLabel}</span>
                            </>
                          )}
                        </div>
