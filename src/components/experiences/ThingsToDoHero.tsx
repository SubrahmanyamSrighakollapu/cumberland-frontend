...
import { thingsToDoHeroData } from "@/data/things-to-do";
...
export default function ThingsToDoHero() {
  ...
  return (
    <section className="relative w-full h-[450px] sm:h-[480px] lg:h-[510px] flex items-center overflow-hidden bg-[#0f302a]">
      {/* Background Image */}
