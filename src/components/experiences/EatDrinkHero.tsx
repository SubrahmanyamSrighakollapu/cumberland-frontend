...
import { eatDrinkHeroData } from "@/data/eat-and-drink";
import Reveal from "@/components/ui/Reveal";

export default function EatDrinkHero() {
  const {
    breadcrumb,
    eyebrow,
    heading,
  ...
  return (
    <section className="relative w-full h-[480px] sm:h-[500px] lg:h-[530px] flex items-center overflow-hidden bg-[#0f302a]">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        ...
        {/* General ambient shadow overlay */}
