...
import { foodItinerarySteps } from "@/data/eat-and-drink";
import Reveal from "@/components/ui/Reveal";

export default function LocalFlavoursItinerary() {
  return (
