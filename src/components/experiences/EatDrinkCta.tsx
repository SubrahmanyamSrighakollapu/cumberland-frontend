...
import { eatDrinkCtaData } from "@/data/eat-and-drink";
import Reveal from "@/components/ui/Reveal";
import { BOOK_DIRECT_URL } from "@/utils/siteLinks";

export default function EatDrinkCta() {
  const { heading, supportingText, primaryCta } = eatDrinkCtaData;
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
            ...
            <div className="flex flex-wrap items-center gap-4 shrink-0">
              ...
              <a
                ...
                className="inline-flex items-center justify-center h-12 bg-white hover:bg-white/90 text-[#80563e] px-6 text-xs sm:text-sm font-semibold tracking-wider uppercase rounded-lg transition-colors shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
                BOOK YOUR STAY &rarr;
              </a>
            </div>
