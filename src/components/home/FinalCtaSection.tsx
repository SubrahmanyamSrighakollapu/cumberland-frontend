          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-normal text-white mb-2 leading-tight">
                Ready to plan your Cessnock stay?
              </h2>
              <p className="text-base sm:text-lg text-white/90 font-sans max-w-2xl">
                Check room availability at Cumberland Motor Inn for comfortable motel accommodation close to Hunter Valley wineries, dining, and attractions.
              </p>
            </div>
