...
export default function HeroCarousel({
  ...
  return (
    ...
    >
      ...
      {/* Slide Indicators & Play/Pause Toggle */}
      <div className="absolute bottom-6 md:bottom-16 left-1/2 -translate-x-1/2 z-30 flex items-center gap-3 pointer-events-auto bg-[#0f302a]/40 px-3 py-1.5 rounded-full border border-white/10 backdrop-blur-xs">
        {/* Play/Pause Button */}
        <button
            ...
            return (
              <button
                ...
                className={`h-2.5 rounded-full transition-all duration-500 ${
                  isActive
                    ? "w-9 bg-gradient-to-r from-[#e8c5af] to-[#80563e] shadow-[0_0_10px_rgba(232,197,175,0.7)] scale-105"
