      ...
      <Reveal direction="up" distance={12} duration={550}>
        ...
        >
          ...
          <div className="p-2 md:pl-4 pt-3 md:pt-2">
            <button
              type="submit"
              className="group w-full h-[52px] bg-[#80563e] hover:bg-[#69452f] active:bg-[#583824] text-white text-sm font-semibold tracking-wider uppercase rounded-lg transition-colors flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#80563e] cursor-pointer"
            >
